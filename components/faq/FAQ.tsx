...
// const faqs = [
//   { question: "How does Solana Gift Cards work?", answer: "Solana Gift Cards allows you to create and send digital gift cards using Solana blockchain. You can specify the amount, add a personal message, and send it instantly to anyone with a Solana wallet." },
//   { question: "Is it secure?", answer: "Yes, we use military-grade encryption and leverage the security of the Solana blockchain to ensure your gifts are safe and can only be claimed by the intended recipient." },
//   { question: "What currencies can I gift?", answer: "Currently, you can gift SOL and any SPL tokens supported on the Solana network. We're constantly working on adding support for more tokens." },
//   { question: "Are there any fees?", answer: "We charge a small fee for creating and sending gift cards. The fee is used to cover operational costs and Solana network fees. You can view the exact fee before confirming your gift card creation." },
// ]
...
//         {faqs.map((faq, index) => (
//           <AccordionItem key={index} value={`item-${index}`} className="bg-gray-800 bg-opacity-50 border border-gray-700 backdrop-blur-sm">
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">
            Everything you need to know about Solana Gift Cards
          </p>
        </motion.div>
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <AccordionTrigger className="flex items-center gap-4 p-6 text-left hover:no-underline [&[data-state=open]>div>.plus]:rotate-45">
                  ...
                  <Plus className="plus h-5 w-5 text-purple-400 transition-transform duration-200" />
                </AccordionTrigger>
